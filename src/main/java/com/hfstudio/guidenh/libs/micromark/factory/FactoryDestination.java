...
public class FactoryDestination {
    ...
    private static class StateMachine {
        ...
        private State start(int code) {
            ...
            if (code == Codes.eof || code == Codes.rightParenthesis || CharUtil.asciiControl(code)) {
        ...
        private State destinationEnclosed(int code) {
            ...
            if (code == Codes.eof || code == Codes.lessThan || CharUtil.markdownLineEnding(code)) {
                return nok.step(code);
            }

            effects.consume(code);
            return code == Codes.backslash ? this::destinationEnclosedEscape : this::destinationEnclosed;
        }
