...
public class HtmlText {
    ...
    private static class StateMachine {
        ...
        private State tagOpen(int code) {
            ...
            if (code == Codes.slash || code == Codes.greaterThan || CharUtil.markdownLineEndingOrSpace(code)) {
        ...
        private State tagOpenAttributeValueUnquoted(int code) {
            ...
            if (code == Codes.greaterThan || code == Codes.slash || CharUtil.markdownLineEndingOrSpace(code)) {
                return tagOpenBetween(code);
            }
