...
public class Construct {
     ...
     */
    public static List<Tokenizer.Event> resolveAll(List<Construct> constructs, List<Tokenizer.Event> events,
     ...
     * Call all `resolveAll`s.
     */
    public static List<Tokenizer.Event> resolveAll(Iterable<Resolver> resolvers, List<Tokenizer.Event> events,
        TokenizeContext context) {
        var called = new HashSet<Resolver>();
