...
public final class AutoLink {
    ...
    static class StateMachine {
        ...
        private State schemeOrEmailAtext(int code) {
            return code == Codes.plusSign || code == Codes.dash || code == Codes.dot || CharUtil.asciiAlphanumeric(code)
        ...
        private State schemeInsideOrEmailAtext(int code) {
            ...
            if ((code == Codes.plusSign || code == Codes.dash || code == Codes.dot || CharUtil.asciiAlphanumeric(code))
        ...
        private State urlInside(int code) {
            ...
            if (code == Codes.eof || code == Codes.space || code == Codes.lessThan || CharUtil.asciiControl(code)) {
        ...
        private State emailValue(int code) {
            if ((code == Codes.dash || CharUtil.asciiAlphanumeric(code)) && size++ < Constants.autolinkDomainSizeMax) {
                effects.consume(code);
