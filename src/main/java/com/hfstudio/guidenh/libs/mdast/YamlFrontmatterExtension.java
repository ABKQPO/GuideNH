...
public class YamlFrontmatterExtension {
    ...
    public static void open(MdastContext context, Token token) {
        context.enter(new MdAstYamlFrontmatter(), token);
        context.buffer();
    }

    public static void close(MdastContext context, Token token) {
    ...
    public static void value(MdastContext context, Token token) {
