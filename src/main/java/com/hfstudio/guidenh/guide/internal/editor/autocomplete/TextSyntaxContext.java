...
public final class TextSyntaxContext {
    ...
    public SyntaxElementType getElementType() { return elementType; }
    public int getElementStart() { return elementStart; }
    public int getElementEnd() { return elementEnd; }
    @Nullable
    public AutocompleteContext getAutocomplete() { return autocomplete; }
    public boolean shouldAutocomplete() { return autocomplete != null; }
}
