            ...
            switch (message.getAction()) {
                case GuideNhStructureRequestMessage.ACTION_CACHE:
                    GuideNhStructureRuntime.getServerSessionStore()
                        .remember(playerId, "client-cache", message.getStructureText());
                    break;
                case GuideNhStructureRequestMessage.ACTION_IMPORT_AND_PLACE:
                    ...
                    GuideStructureMemoryStore.Entry entry = GuideNhStructureRuntime.getServerSessionStore()
                ...
                case GuideNhStructureRequestMessage.ACTION_PLACE_ALL:
                    ...
                    if (GuideNhStructureRuntime.getServerSessionStore()
                        .isEmpty(playerId)) {
