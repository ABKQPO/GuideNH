...
public final class ExpMaterial extends Table {
    ...
    public static ExpMaterial getRootAsExpMaterial(ByteBuffer _bb) {
        return getRootAsExpMaterial(_bb, new ExpMaterial());
    }

    public static ExpMaterial getRootAsExpMaterial(ByteBuffer _bb, ExpMaterial obj) {
    ...
    public ExpMaterial __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public ByteBuffer shaderNameAsByteBuffer() {
        return __vector_as_bytebuffer(6, 1);
    }

    public ByteBuffer shaderNameInByteBuffer(ByteBuffer _bb) {
    ...
    public boolean mutateDisableCulling(boolean disable_culling) {
        int o = __offset(8);
        if (o != 0) {
            bb.put(o + bb_pos, (byte) (disable_culling ? 1 : 0));
            return true;
        } else {
            return false;
        }
    ...
    public boolean mutateTransparency(int transparency) {
        int o = __offset(10);
        if (o != 0) {
            bb.put(o + bb_pos, (byte) transparency);
            return true;
        } else {
            return false;
        }
    ...
    public boolean mutateDepthTest(int depth_test) {
        int o = __offset(12);
        if (o != 0) {
            bb.put(o + bb_pos, (byte) depth_test);
            return true;
        } else {
            return false;
        }
    ...
    public static void startExpMaterial(FlatBufferBuilder builder) {
        builder.startTable(6);
    }
    ...
    public static void addShaderName(FlatBufferBuilder builder, int shaderNameOffset) {
        builder.addOffset(1, shaderNameOffset, 0);
    }

    public static void addDisableCulling(FlatBufferBuilder builder, boolean disableCulling) {
        builder.addBoolean(2, disableCulling, false);
    }

    public static void addTransparency(FlatBufferBuilder builder, int transparency) {
        builder.addByte(3, (byte) transparency, (byte) 0);
    }

    public static void addDepthTest(FlatBufferBuilder builder, int depthTest) {
        builder.addByte(4, (byte) depthTest, (byte) 0);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public ExpMaterial get(int j) {
            return get(new ExpMaterial(), j);
        }

        public ExpMaterial get(ExpMaterial obj, int j) {
