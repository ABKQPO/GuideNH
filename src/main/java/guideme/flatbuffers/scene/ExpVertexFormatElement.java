...
public final class ExpVertexFormatElement extends Struct {
    ...
    public int type() {
        return bb.get(bb_pos + 1) & 0xFF;
    }

    public void mutateType(int type) {
        bb.put(bb_pos + 1, (byte) type);
    }

    public int usage() {
        return bb.get(bb_pos + 2) & 0xFF;
    }

    public void mutateUsage(int usage) {
        bb.put(bb_pos + 2, (byte) usage);
    }

    public int count() {
        return bb.get(bb_pos + 3) & 0xFF;
    }

    public void mutateCount(int count) {
        bb.put(bb_pos + 3, (byte) count);
    }

    public int offset() {
        return bb.get(bb_pos + 4) & 0xFF;
    }

    public void mutateOffset(int offset) {
        bb.put(bb_pos + 4, (byte) offset);
    }

    public int byteSize() {
        return bb.get(bb_pos + 5) & 0xFF;
    }

    public void mutateByteSize(int byte_size) {
        bb.put(bb_pos + 5, (byte) byte_size);
    }

    public boolean normalized() {
        return 0 != bb.get(bb_pos + 6);
    }

    public void mutateNormalized(boolean normalized) {
        bb.put(bb_pos + 6, (byte) (normalized ? 1 : 0));
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public ExpVertexFormatElement get(int j) {
            return get(new ExpVertexFormatElement(), j);
        }

        public ExpVertexFormatElement get(ExpVertexFormatElement obj, int j) {
