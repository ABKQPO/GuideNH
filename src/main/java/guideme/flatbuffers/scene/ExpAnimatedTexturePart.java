...
public final class ExpAnimatedTexturePart extends Table {
    ...
    public static ExpAnimatedTexturePart getRootAsExpAnimatedTexturePart(ByteBuffer _bb) {
        return getRootAsExpAnimatedTexturePart(_bb, new ExpAnimatedTexturePart());
    }
    ...
    public boolean mutateFrameCount(long frame_count) {
        int o = __offset(16);
        if (o != 0) {
            bb.putInt(o + bb_pos, (int) frame_count);
            return true;
        } else {
            return false;
        }
    ...
    public boolean mutateFramesPerRow(long frames_per_row) {
        int o = __offset(18);
        if (o != 0) {
            bb.putInt(o + bb_pos, (int) frames_per_row);
            return true;
        } else {
            return false;
        }
    ...
    public guideme.flatbuffers.scene.ExpAnimatedTexturePartFrame frames(int j) {
        return frames(new guideme.flatbuffers.scene.ExpAnimatedTexturePartFrame(), j);
    }
    ...
    public guideme.flatbuffers.scene.ExpAnimatedTexturePartFrame.Vector framesVector() {
        return framesVector(new guideme.flatbuffers.scene.ExpAnimatedTexturePartFrame.Vector());
    }
    ...
    public static void startExpAnimatedTexturePart(FlatBufferBuilder builder) {
        builder.startTable(9);
    }

    public static void addTextureId(FlatBufferBuilder builder, int textureIdOffset) {
        builder.addOffset(0, textureIdOffset, 0);
    }
    ...
    public static void addFramesPath(FlatBufferBuilder builder, int framesPathOffset) {
        builder.addOffset(5, framesPathOffset, 0);
    }

    public static void addFrameCount(FlatBufferBuilder builder, long frameCount) {
        builder.addInt(6, (int) frameCount, (int) 0L);
    }

    public static void addFramesPerRow(FlatBufferBuilder builder, long framesPerRow) {
        builder.addInt(7, (int) framesPerRow, (int) 0L);
    }

    public static void addFrames(FlatBufferBuilder builder, int framesOffset) {
        builder.addOffset(8, framesOffset, 0);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public ExpAnimatedTexturePart get(int j) {
            return get(new ExpAnimatedTexturePart(), j);
        }

        public ExpAnimatedTexturePart get(ExpAnimatedTexturePart obj, int j) {
