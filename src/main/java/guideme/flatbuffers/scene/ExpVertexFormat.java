...
public final class ExpVertexFormat extends Table {
    ...
    public static ExpVertexFormat getRootAsExpVertexFormat(ByteBuffer _bb) {
        return getRootAsExpVertexFormat(_bb, new ExpVertexFormat());
    }

    public static ExpVertexFormat getRootAsExpVertexFormat(ByteBuffer _bb, ExpVertexFormat obj) {
    ...
    public ExpVertexFormat __assign(int _i, ByteBuffer _bb) {
        __init(_i, _bb);
        return this;
    }
    ...
    public boolean mutateVertexSize(int vertex_size) {
        int o = __offset(6);
        if (o != 0) {
            bb.put(o + bb_pos, (byte) vertex_size);
            return true;
        } else {
            return false;
        }
    ...
    public static void startExpVertexFormat(FlatBufferBuilder builder) {
        builder.startTable(2);
    }
    ...
    public static void addVertexSize(FlatBufferBuilder builder, int vertexSize) {
        builder.addByte(1, (byte) vertexSize, (byte) 0);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public ExpVertexFormat get(int j) {
            return get(new ExpVertexFormat(), j);
        }

        public ExpVertexFormat get(ExpVertexFormat obj, int j) {
