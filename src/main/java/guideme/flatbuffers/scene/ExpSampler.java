...
public final class ExpSampler extends Table {
    ...
    public static ExpSampler getRootAsExpSampler(ByteBuffer _bb) {
        return getRootAsExpSampler(_bb, new ExpSampler());
    }
    ...
    public boolean mutateLinearFiltering(boolean linear_filtering) {
        int o = __offset(8);
        if (o != 0) {
            bb.put(o + bb_pos, (byte) (linear_filtering ? 1 : 0));
            return true;
        } else {
            return false;
        }
    ...
    public boolean mutateUseMipmaps(boolean use_mipmaps) {
        int o = __offset(10);
        if (o != 0) {
            bb.put(o + bb_pos, (byte) (use_mipmaps ? 1 : 0));
            return true;
        } else {
            return false;
        }
    ...
    public static void startExpSampler(FlatBufferBuilder builder) {
        builder.startTable(4);
    }
    ...
    public static void addTexture(FlatBufferBuilder builder, int textureOffset) {
        builder.addOffset(1, textureOffset, 0);
    }

    public static void addLinearFiltering(FlatBufferBuilder builder, boolean linearFiltering) {
        builder.addBoolean(2, linearFiltering, false);
    }

    public static void addUseMipmaps(FlatBufferBuilder builder, boolean useMipmaps) {
        builder.addBoolean(3, useMipmaps, false);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public ExpSampler get(int j) {
            return get(new ExpSampler(), j);
        }

        public ExpSampler get(ExpSampler obj, int j) {
