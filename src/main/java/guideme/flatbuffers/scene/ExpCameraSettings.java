...
public final class ExpCameraSettings extends Struct {
    ...
    public void mutateZoom(float zoom) {
        bb.putFloat(bb_pos + 12, zoom);
    }

    public static int createExpCameraSettings(FlatBufferBuilder builder, float yaw, float pitch, float roll,
            float zoom) {
        builder.prep(4, 16);
    ...
    public static final class Vector extends BaseVector {
        ...
        public ExpCameraSettings get(int j) {
            return get(new ExpCameraSettings(), j);
        }

        public ExpCameraSettings get(ExpCameraSettings obj, int j) {
