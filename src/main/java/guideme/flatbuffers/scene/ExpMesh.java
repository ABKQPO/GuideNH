...
public final class ExpMesh extends Table {
    ...
    public static ExpMesh getRootAsExpMesh(ByteBuffer _bb) {
        return getRootAsExpMesh(_bb, new ExpMesh());
    }
    ...
    public boolean mutatePrimitiveType(int primitive_type) {
        int o = __offset(8);
        if (o != 0) {
            bb.put(o + bb_pos, (byte) primitive_type);
            return true;
        } else {
            return false;
        }
    ...
    public ByteVector indexBufferVector(ByteVector obj) {
        int o = __offset(10);
    ...
    public boolean mutateIndexType(int index_type) {
        int o = __offset(12);
        if (o != 0) {
            bb.put(o + bb_pos, (byte) index_type);
            return true;
        } else {
            return false;
        }
    ...
    public boolean mutateIndexCount(long index_count) {
        int o = __offset(14);
        if (o != 0) {
            bb.putInt(o + bb_pos, (int) index_count);
            return true;
        } else {
            return false;
        }
    ...
    public ByteVector vertexBufferVector(ByteVector obj) {
        int o = __offset(16);
        return o != 0 ? obj.__assign(__vector(o), bb) : null;
    }
    ...
    public static void startExpMesh(FlatBufferBuilder builder) {
        builder.startTable(7);
    }
    ...
    public static void addVertexFormat(FlatBufferBuilder builder, int vertexFormatOffset) {
        builder.addOffset(1, vertexFormatOffset, 0);
    }

    public static void addPrimitiveType(FlatBufferBuilder builder, int primitiveType) {
        builder.addByte(2, (byte) primitiveType, (byte) 0);
    }

    public static void addIndexBuffer(FlatBufferBuilder builder, int indexBufferOffset) {
        builder.addOffset(3, indexBufferOffset, 0);
    }

    public static int createIndexBufferVector(FlatBufferBuilder builder, byte[] data) {
        return builder.createByteVector(data);
    }

    public static int createIndexBufferVector(FlatBufferBuilder builder, ByteBuffer data) {
        return builder.createByteVector(data);
    }

    public static void startIndexBufferVector(FlatBufferBuilder builder, int numElems) {
        builder.startVector(1, numElems, 1);
    }

    public static void addIndexType(FlatBufferBuilder builder, int indexType) {
        builder.addByte(4, (byte) indexType, (byte) 0);
    }

    public static void addIndexCount(FlatBufferBuilder builder, long indexCount) {
        builder.addInt(5, (int) indexCount, (int) 0L);
    }

    public static void addVertexBuffer(FlatBufferBuilder builder, int vertexBufferOffset) {
        builder.addOffset(6, vertexBufferOffset, 0);
    }

    public static int createVertexBufferVector(FlatBufferBuilder builder, byte[] data) {
        return builder.createByteVector(data);
    }

    public static int createVertexBufferVector(FlatBufferBuilder builder, ByteBuffer data) {
        return builder.createByteVector(data);
    }

    public static void startVertexBufferVector(FlatBufferBuilder builder, int numElems) {
        builder.startVector(1, numElems, 1);
    }
    ...
    public static final class Vector extends BaseVector {
        ...
        public ExpMesh get(int j) {
            return get(new ExpMesh(), j);
        }

        public ExpMesh get(ExpMesh obj, int j) {
